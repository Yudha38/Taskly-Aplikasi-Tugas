          ...
          child: Column(
            children: [
              TextFormField(
                ...
                maxLength: 100,
                decoration:
                    const InputDecoration(label: Text('Masukkan judul tugas')),
                validator: (value) {
                  if (value == null ||
                      value.trim().isEmpty ||
                      value.trim().length < 5) {
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                    label: Text('Masukkan deskripsi tugas')),
                validator: (value) {
                  if (value == null ||
                      value.trim().isEmpty ||
              ...
              DropdownButtonFormField(
                hint: const Text('Pilih kategori tugas'),
                validator: (value) {
                  if (value == null) {
              ...
              const SizedBox(height: 16),
              DropdownButtonFormField(
                hint: const Text('Pilih status tugas'),
                validator: (value) {
                  if (value == null) {
                    return 'Tolong pilih status tugas';
                  }
                  return null;
                },
